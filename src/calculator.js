...
export class MarginCalculator {
  static calculate(params = {}) {
    ...
    const categoryCode = params.categoryCode !== undefined ? params.categoryCode : (product ? (product.coupangCategoryCode || null) : null);
    ...
    // 1. 원가 또는 배송비 또는 판매가가 없으면 계산 불가 처리
    ...
    return {
      ...
      targetDailyProfit,
      requiredDailySales,
      dailyRequiredQty: requiredDailySales,
